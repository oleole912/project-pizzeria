...

{
  ...
  class Product {
    ...
    initAccordion() {
      ...
      // old - const clickableTrigger = thisProduct.element.querySelector(select.menuProduct.clickable);
    ...
    processOrder() {
      ...
      // read which options has been chosen
      ...
      for(let paramId in thisProduct.data.params) {
        ...
        for(let optionId in param.options) {
          ...
          if (optionSelected) {
            ...
            // deduct option price from a price variable
            price -= option.price;
          }

          // find img with class paramId-optionId in img wrapper
    ...
    prepareCartProductParams(){
      ...
      // declare params as an empty object
      let params = {};
  ...
  class Cart {
    ...
    remove(cartProduct){
      ...
      const removedProduct = thisCart.products.indexOf(cartProduct);
